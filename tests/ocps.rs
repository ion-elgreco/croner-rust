...
mod ocps_1_0_tests {
    ...
    fn test_logical_or_for_date_fields() {
        ...
        let first_of_month = CivilDateTime::from_ymd_hms(2025, 7, 1, 12, 0, 0).unwrap(); // A Tuesday
        let a_monday = CivilDateTime::from_ymd_hms(2025, 7, 14, 12, 0, 0).unwrap(); // Not the 1st
...
mod ocps_1_3_tests {
    ...
    fn test_last_day_of_month() {
        ...
        let last_of_july = CivilDateTime::from_ymd_hms(2025, 7, 31, 0, 0, 0).unwrap();
        let not_last_of_july = CivilDateTime::from_ymd_hms(2025, 7, 30, 0, 0, 0).unwrap();
    ...
    fn test_last_weekday_of_month() {
        ...
        let last_friday = CivilDateTime::from_ymd_hms(2025, 7, 25, 0, 0, 0).unwrap();
        let not_last_friday = CivilDateTime::from_ymd_hms(2025, 7, 18, 0, 0, 0).unwrap();
    ...
    fn test_nth_weekday_of_month() {
        ...
        let second_tuesday = CivilDateTime::from_ymd_hms(2025, 7, 8, 0, 0, 0).unwrap();
        let first_tuesday = CivilDateTime::from_ymd_hms(2025, 7, 1, 0, 0, 0).unwrap();
    ...
    fn test_closest_weekday() {
        ...
        let closest_weekday = CivilDateTime::from_ymd_hms(2025, 7, 4, 0, 0, 0).unwrap();
    ...
    fn test_last_weekday_lw() {
        ...
        let feb_last_weekday = CivilDateTime::from_ymd_hms(2025, 2, 28, 0, 0, 0).unwrap();
        assert!(
        ...
        let aug_last_weekday = CivilDateTime::from_ymd_hms(2025, 8, 29, 0, 0, 0).unwrap();
        assert!(
        ...
        let aug_31 = CivilDateTime::from_ymd_hms(2025, 8, 31, 0, 0, 0).unwrap();
        assert!(
        ...
        let nov_last_weekday = CivilDateTime::from_ymd_hms(2025, 11, 28, 0, 0, 0).unwrap();
        assert!(
        ...
        let nov_30 = CivilDateTime::from_ymd_hms(2025, 11, 30, 0, 0, 0).unwrap();
        assert!(
    ...
    fn test_31w_only_triggers_if_31st_exists() {
        ...
        let jan_31 = CivilDateTime::from_ymd_hms(2025, 1, 31, 0, 0, 0).unwrap();
        assert!(
        ...
        let feb_28 = CivilDateTime::from_ymd_hms(2025, 2, 28, 0, 0, 0).unwrap();
        assert!(
        ...
        let apr_30 = CivilDateTime::from_ymd_hms(2025, 4, 30, 0, 0, 0).unwrap();
        assert!(
        ...
        let may_30 = CivilDateTime::from_ymd_hms(2025, 5, 30, 0, 0, 0).unwrap();
        assert!(
        ...
        let aug_29 = CivilDateTime::from_ymd_hms(2025, 8, 29, 0, 0, 0).unwrap();
        assert!(
    ...
    fn test_lw_find_next_occurrences() {
        ...
        let start_date = CivilDateTime::from_ymd_hms(2025, 1, 1, 0, 0, 0).unwrap();
...
mod ocps_1_4_tests {
    ...
    fn test_and_modifier() {
        ...
        let first_is_monday = CivilDateTime::from_ymd_hms(2025, 9, 1, 12, 0, 0).unwrap();
        // July 1st, 2025 is a Tuesday.
        let first_is_not_monday = CivilDateTime::from_ymd_hms(2025, 7, 1, 12, 0, 0).unwrap();
    ...
    fn test_global_and_mode() {
        ...
        let first_is_monday = CivilDateTime::from_ymd_hms(2025, 9, 1, 12, 0, 0).unwrap();
        let first_is_not_monday = CivilDateTime::from_ymd_hms(2025, 7, 1, 12, 0, 0).unwrap();
        let a_monday_not_first = CivilDateTime::from_ymd_hms(2025, 7, 14, 12, 0, 0).unwrap();
